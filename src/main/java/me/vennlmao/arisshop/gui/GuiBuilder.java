package me.vennlmao.arisshop.gui;
...
public class GuiBuilder {
    ...
    public static Inventory buildMainShop(ArisShop plugin) {
    ...
    public static Inventory buildCategory(ArisShop plugin, String category) {
        java.io.File f = new java.io.File(plugin.getDataFolder(), "categories/" + category + ".yml");
    ...
    public static Inventory buildPurchase(ArisShop plugin, ShopItem item, int amount) {
    ...
    private static void placeDisplay(ArisShop plugin, Inventory inv, ShopItem item, int amount) {
        ...
        ItemStack dispItem = new ItemStack(item.getMaterial());
    ...
    private static void placeButton(ArisShop plugin, Inventory inv, String path,
